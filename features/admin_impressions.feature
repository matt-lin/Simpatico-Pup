Feature: View Site Analytics of Simpatico Pup
  ...
  Background: Logged in and dogs have been added to the database
    ...
    Given the following customizes exist:
      | id | name                      | content                    | location |
      | 27 | Function_leftmost_Top     | Contribute to Our Database | fuction  |
      | 28 | Function_leftmost_Bottom  | Rate your Dog              | fuction  |
      | 29 | Function_left_mid_Top     | Find Ratings for a | fuction |
      | 30 | Function_left_mid_Bottom  | Dog Breed | fuction | 
      | 31 | Function_right_mid_Top    | Find Ratings for a | fuction |
      | 32 | Function_right_mid_Bottom | Dog Breeder or Kennel | fuction |
      | 33 | Function_rightmost_Top    | Geographic Search for a | fuction |
      | 34 | Function_rightmost_Bottom | Dog Breeder or Kennel | fuction |
